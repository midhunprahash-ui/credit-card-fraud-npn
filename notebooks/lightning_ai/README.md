...
The shareable instructions are in
[the teammate training guide](../../docs/TEAMMATE_TRAINING_GUIDE.md).
A browser-friendly HTML export may be kept locally, but it is intentionally
ignored by Git.
Complete technical instructions are in
[the Lightning training guide](../../docs/LIGHTNING_TRAINING_GUIDE.md).
